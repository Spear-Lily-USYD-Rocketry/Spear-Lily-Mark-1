...
static const uint8_t UBX_NAV_CLOCK_ID_ = 0x22;
static const uint8_t UBX_NAV_DOP_ID_ = 0x04;
static const uint8_t UBX_NAV_EOE_ID_ = 0x61;
static const uint8_t UBX_NAV_GEOFENCE_ID_ = 0x39;
static const uint8_t UBX_NAV_HPPOSECEF_ID_ = 0x13;
static const uint8_t UBX_NAV_HPPOSLLH_ID_ = 0x14;
static const uint8_t UBX_NAV_ODO_ID_ = 0x09;
static const uint8_t UBX_NAV_ORB_ID_ = 0x34;
static const uint8_t UBX_NAV_POSECEF_ID_ = 0x01;
static const uint8_t UBX_NAV_POSLLH_ID_ = 0x02;
static const uint8_t UBX_NAV_PVT_ID_ = 0x07;
static const uint8_t UBX_NAV_RELPOSNED_ID_ = 0x3c;
static const uint8_t UBX_NAV_RESETODO_ID_ = 0x10;
static const uint8_t UBX_NAV_SAT_ID_ = 0x35;
static const uint8_t UBX_NAV_SBAS_ID_ = 0x32;
static const uint8_t UBX_NAV_SIG_ID_ = 0x43;
static const uint8_t UBX_NAV_SLAS_ID_ = 0x42;
static const uint8_t UBX_NAV_STATUS_ID_ = 0x03;
static const uint8_t UBX_NAV_SVIN_ID_ = 0x3b;
static const uint8_t UBX_NAV_TIMEBDS_ID_ = 0x24;
static const uint8_t UBX_NAV_TIMEGAL_ID_ = 0x25;
static const uint8_t UBX_NAV_TIMEGLO_ID_ = 0x23;
static const uint8_t UBX_NAV_TIMEGPS_ID_ = 0x20;
static const uint8_t UBX_NAV_TIMELS_ID_ = 0x26;
static const uint8_t UBX_NAV_TIMEQZSS_ID_ = 0x27;
static const uint8_t UBX_NAV_TIMEUTC_ID_ = 0x21;
static const uint8_t UBX_NAV_VELECEF_ID_ = 0x11;
static const uint8_t UBX_NAV_VELNED_ID_ = 0x12;
/* UBX-NAV messages */
struct UbxNavClock {
  static const uint8_t cls = UBX_NAV_CLS_;
  static const uint8_t id = UBX_NAV_CLOCK_ID_;
  static const uint16_t len = 20;
  struct {
...
struct UbxNavDop {
  static const uint8_t cls = UBX_NAV_CLS_;
  static const uint8_t id = UBX_NAV_DOP_ID_;
  static const uint16_t len = 18;
  struct {
    U4 i_tow;   // GPS time of week, ms
...
struct UbxNavEoe {
  static const uint8_t cls = UBX_NAV_CLS_;
  static const uint8_t id = UBX_NAV_EOE_ID_;
  static const uint16_t len = 4;
  struct {
    U4 i_tow;   // GPS time of week, ms
  } payload;
};
...
struct UbxNavGeofence {
  const uint8_t cls = UBX_NAV_CLS_;
  const uint8_t id = UBX_NAV_GEOFENCE_ID_;
  uint16_t len;
  struct {
    U4 i_tow;               // GPS time of week, ms
...
struct UbxNavHpposecef {
  static const uint8_t cls = UBX_NAV_CLS_;
  static const uint8_t id = UBX_NAV_HPPOSECEF_ID_;
  static const uint16_t len = 28;
  struct {
    U1 version;         // Message version
    U1 reserved0[3];
    U4 i_tow;           // GPS time of week, ms
...
struct UbxNavHpposllh {
  static const uint8_t cls = UBX_NAV_CLS_;
  static const uint8_t id = UBX_NAV_HPPOSLLH_ID_;
  static const uint16_t len = 36;
  struct {
    U1 version;         // Message version
    U1 reserved0[2];
    X1 flags;           // Flags
...
struct UbxNavOdo {
  static const uint8_t cls = UBX_NAV_CLS_;
  static const uint8_t id = UBX_NAV_ODO_ID_;
  static const uint16_t len = 20;
  struct {
    U1 version;         // Message version
    U1 reserved0[3];
...
struct UbxNavOrb {
  const uint8_t cls = UBX_NAV_CLS_;
  const uint8_t id = UBX_NAV_ORB_ID_;
  uint16_t len;
  struct {
    U4 i_tow;           // GPS time of week, ms
    U1 version;         // Message version
...
struct UbxNavPosecef {
  static const uint8_t cls = UBX_NAV_CLS_;
  static const uint8_t id = UBX_NAV_POSECEF_ID_;
  static const uint16_t len = 20;
  struct {
    U4 i_tow;   // GPS time of week, ms
    I4 ecef_x;  // ECEF x coordinate, cm
...
struct UbxNavPosllh {
  static const uint8_t cls = UBX_NAV_CLS_;
  static const uint8_t id = UBX_NAV_POSLLH_ID_;
  static const uint16_t len = 28;
  struct {
    U4 i_tow;   // GPS time of week, ms
    I4 lon;     // Longitude, deg, scale 1e-7
...
struct UbxNavPvt {
  static const uint8_t cls = UBX_NAV_CLS_;
  static const uint8_t id = UBX_NAV_PVT_ID_;
  static const uint16_t len = 92;
  struct {
    U4 i_tow;       // GPS time of week, ms
    U2 year;        // Year (UTC)
    U1 month;       // Month (UTC)
...
struct UbxNavRelposned {
  static const uint8_t cls = UBX_NAV_CLS_;
  static const uint8_t id = UBX_NAV_RELPOSNED_ID_;
  static const uint16_t len = 64;
  struct {
    U1 version;             // Message version
    U1 reserved0;
...
struct UbxNavResetodo {
  static const uint8_t cls = UBX_NAV_CLS_;
  static const uint8_t id = UBX_NAV_RESETODO_ID_;
  static const uint16_t len = 0;
};
template<std::size_t N>  // templated by maximum number of satellites
struct UbxNavSat {
  static const uint8_t cls = UBX_NAV_CLS_;
  static const uint8_t id = UBX_NAV_SAT_ID_;
  uint16_t len;
  struct {
    U4 i_tow;         // GPS time of week, ms
    U1 version;       // Message version
...
struct UbxNavSbas {
  static const uint8_t cls = UBX_NAV_CLS_;
  static const uint8_t id = UBX_NAV_SBAS_ID_;
  uint16_t len;
  struct {
    U4 i_tow;         // GPS time of week, ms
...
struct UbxNavSig {
  static const uint8_t cls = UBX_NAV_CLS_;
  static const uint8_t id = UBX_NAV_SIG_ID_;
  uint16_t len;
  struct {
    U4 i_tow;           // GPS time of week, ms
    U1 version;         // Message version
...
struct UbxNavSlas {
  static const uint8_t cls = UBX_NAV_CLS_;
  static const uint8_t id = UBX_NAV_SLAS_ID_;
  uint16_t len;
  struct {
    U4 i_tow;             // GPS time of week, ms
    U1 version;           // Message version
...
struct UbxNavStatus {
  static const uint8_t cls = UBX_NAV_CLS_;
  static const uint8_t id = UBX_NAV_STATUS_ID_;
  static const uint16_t len = 16;
  struct {
    U4 i_tow;       // GPS time of week, ms
...
struct UbxNavSvin {
  static const uint8_t cls = UBX_NAV_CLS_;
  static const uint8_t id = UBX_NAV_SVIN_ID_;
  static const uint16_t len = 40;
  struct {
    U1 version;       // Message version
    U1 reserved0[3];
    U4 i_tow;         // GPS time of week, ms
...
struct UbxNavTimebds {
  static const uint8_t cls = UBX_NAV_CLS_;
  static const uint8_t id = UBX_NAV_TIMEBDS_ID_;
  static const uint16_t len = 20;
  struct {
    U4 i_tow;     // GPS time of week, ms
...
struct UbxNavTimegal {
  static const uint8_t cls = UBX_NAV_CLS_;
  static const uint8_t id = UBX_NAV_TIMEGAL_ID_;
  static const uint16_t len = 20;
  struct {
    U4 i_tow;       // GPS time of week, ms
...
struct UbxNavTimeglo {
  static const uint8_t cls = UBX_NAV_CLS_;
  static const uint8_t id = UBX_NAV_TIMEGLO_ID_;
  static const uint16_t len = 20;
  struct {
    U4 i_tow;       // GPS time of week, ms
...
struct UbxNavTimegps {
  static const uint8_t cls = UBX_NAV_CLS_;
  static const uint8_t id = UBX_NAV_TIMEGPS_ID_;
  static const uint16_t len = 16;
  struct {
    U4 i_tow;   // GPS time of week, ms
...
struct UbxNavTimels {
  static const uint8_t cls = UBX_NAV_CLS_;
  static const uint8_t id = UBX_NAV_TIMELS_ID_;
  static const uint16_t len = 24;
  struct {
    U4 i_tow;               // GPS time of week, ms
    U1 version;             // Message version
    U1 reserved0[3];
...
struct UbxNavTimeqzss {
  static const uint8_t cls = UBX_NAV_CLS_;
  static const uint8_t id = UBX_NAV_TIMEQZSS_ID_;
  static const uint16_t len = 20;
  struct {
    U4 i_tow;       // GPS time of week, ms
...
struct UbxNavTimeutc {
  static const uint8_t cls = UBX_NAV_CLS_;
  static const uint8_t id = UBX_NAV_TIMEUTC_ID_;
  static const uint16_t len = 20;
  struct {
    U4 i_tow;       // GPS time of week, ms
    U4 t_acc;       // Time accuracy estimate (UTC), ns
...
struct UbxNavVelecef {
  static const uint8_t cls = UBX_NAV_CLS_;
  static const uint8_t id = UBX_NAV_VELECEF_ID_;
  static const uint16_t len = 20;
  struct {
    U4 i_tow;     // GPS time of week, ms
...
struct UbxNavVelned {
  static const uint8_t cls = UBX_NAV_CLS_;
  static const uint8_t id = UBX_NAV_VELNED_ID_;
  static const uint16_t len = 36;
  struct {
    U4 i_tow;     // GPS time of week, ms
